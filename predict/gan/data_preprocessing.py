...
# %% --------------------------------------- Load Data  -----------------------------------------------------------------
dataset = pd.read_csv('predict/gan/Finaldata_with_Fourier.csv', parse_dates=['Date'])
news = pd.read_csv("predict/gan/News.csv", parse_dates=["Date"])
...
y_value = pd.DataFrame(dataset.iloc[:, 3])  #close
...
dump(X_scaler, open('predict/gan/X_scaler.pkl', 'wb'))
dump(y_scaler, open('predict/gan/y_scaler.pkl', 'wb'))
