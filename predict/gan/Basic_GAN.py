...
X_train = np.load("predict/gan/X_train.npy", allow_pickle=True)
y_train = np.load("predict/gan/y_train.npy", allow_pickle=True)
X_test = np.load("predict/gan/X_test.npy", allow_pickle=True)
y_test = np.load("predict/gan/y_test.npy", allow_pickle=True)
yc_train = np.load("predict/gan/yc_train.npy", allow_pickle=True)
yc_test = np.load("predict/gan/yc_test.npy", allow_pickle=True)
